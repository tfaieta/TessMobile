...
class Home extends Component{
    ...
    componentDidMount(){
        ...
        // this.rssSingleFetch("http://feeds.nightvalepresents.com/welcometonightvalepodcast", 5);
    ...
    rssFetch(){
        firebase.database().ref(`feedFetcher`).once("value", function (snapshot) {
            ...
            firebase.database().ref(`feedFetcher`).set(data);
        });
    ...
    rssSingleFetch(link, numOfEps){

        // Check if the data looks good,
        // Account for profile image url
        // Add it yourself if it doesn't update it
        // Remember to set the category in Category.js
